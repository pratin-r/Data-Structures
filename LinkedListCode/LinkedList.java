public class LinkedList {
    ...
    /*
     * important
     * for insertFirst and insertLast, visualize by using two nodes atleast so that
     * you can understand
     * the concept of head and tail and how it works
     */
    ...
    public void insertLastWithoutTail(int data) {
        if (head == null) {
            ...
            temp.next = newNode; // now the newly created node address is stored in it(it refers to the previous
                                 // node)
            size++;
        }
    }
    ...
    public int deleteLast1() {
        ...
        tail = secondLastNode;
        // only after storing a value in temp variable like valueToBeRemoved, the link
        // is removed
        tail.next = null;
